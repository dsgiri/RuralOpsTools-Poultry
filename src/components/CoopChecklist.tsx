  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8">
      <div className="flex items-center gap-3 border-b-2 border-line pb-4">
        ...
        <h1 className="text-3xl font-serif text-ink tracking-tight">Coop Checklist</h1>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-3 p-3 bg-kraft border border-line cursor-pointer hover:bg-white transition-colors">
              ...
              />
              <span className="text-ink">Ventilation clear and functioning</span>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 bg-kraft border border-line cursor-pointer hover:bg-white transition-colors">
              <input 
                ...
                className="w-5 h-5 accent-rust text-rust bg-white border-line rounded-sm focus:ring-rust focus:ring-offset-kraft" 
              />
              <span className="text-ink">Bedding dry and sufficient</span>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 bg-kraft border border-line cursor-pointer hover:bg-white transition-colors">
              <input 
                ...
                className="w-5 h-5 accent-rust text-rust bg-white border-line rounded-sm focus:ring-rust focus:ring-offset-kraft" 
              />
              <span className="text-ink">Water sources fresh and not frozen</span>
            </label>
            ...
            <label className="flex items-center gap-3 p-3 bg-kraft border border-line cursor-pointer hover:bg-white transition-colors">
              <input 
                ...
                className="w-5 h-5 accent-rust text-rust bg-white border-line rounded-sm focus:ring-rust focus:ring-offset-kraft" 
              />
              <span className="text-ink">Predator-proofing intact (no new holes or digging)</span>
            </label>
          </div>
